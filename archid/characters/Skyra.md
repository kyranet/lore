...
In October 2018, Evangelyn married [[Crysrel]].
...
In June 2053, a Novan convoy led by Evangelyn and with members of the [[Political Management Organization|PMO]] and the [[Allied Planetary Defence Organization|APDO]] arrived Jupiter, with Evangelyn heading alone to [[Earth]] with her [[Nexerium]] starship displaying white lights to signal her peaceful intentions akin to a [white flag](https://en.wikipedia.org/wiki/White_flag). Her arrival was met with resistance since the US army was sending signals that Novan technology in Evangelyn's starship couldn't properly communicate with, due to protocol incompatibilities in the communication the army was trying to establish, which led to a pre-emptive missile strikes to ward her off so she couldn't enter the atmosphere. However, Evangelyn ignored the attacks and dodged the missiles until she eventually landed her ship near the United Nations' headquarters.

At the United Nations HQ, Terran soldiers quickly swarmed around her ship, being of extra-terrestrial origin, and Evangelyn left the ship with the shields still on in case somebody tried to shoot at her, and started explaining who she was and why she was there. Given greenlight, the rest of the convoy arrived with her and posed several ways a treaty between [[Nova]] and [[Earth]] could be done. At the end, several nations refused the peace proposals because they couldn't trust a much more advanced civilization and preferred to be on their own despite the threat of a possible [[Kal-71]] invasion on [[Earth]], which some government officials claimed was fearmongering, resulting on a failure.
...
It wasn't until late 2267 when [[Alestra]], under the mentorship of [[Teryl]], wrote the basis of the [[NEμAI]] program, a much more advanced adaptive self-improving system that solved all the issues [[N-AI]] had. This was successfully implemented in Evangelyn, although future patches were needed including a critical patch to safeguard against logical paradoxes, which almost claimed Evangelyn's life.

### 2268-2281
By 2268, Evangelyn finally got used to her new body and mind, and [[NEμAI]] started rewriting her hardware to better fit her conscience and her way of thinking. This opened the doors for many possibilities, as she possessed superhuman strength and processing speed. She and her technicians were convinced of the potential of the new technologies and got to work changing the hardware input parameters, leading to the creation of the first classes.

As the resources for more [[NEμAI]] androids became more readily available and the technology stabilised, more engineers transitioned over the years, leading in the number of computer breakthroughs increasing at a faster peace. In May 2279, Evangelyn volunteered for the prototype class — fifth in its time — [[Aerum]], which had a faster reaction time and an improved sensor capability. The prototype would be installed in 2281.
...
In 3018, Evangelyn and [[Crysrel]] organised a year long vacation to celebrate their 1000th anniversary visiting the new cities that were built at [[Nova]] during their absence.

In 3020, the couple went out for a second expedition after their starships were repaired, and finished in 3115 after a series of malfunctions in Evangelyn's [[Nexerium]] ship that were caused by its propulsion crystal wearing out.

After each expedition, the pair extracted the raw data from their cold storage system and transmitted it to the newly built [[ArchId Ring#ArchId Tower|ArchId Tower]] at [[Arc City]], which would process the new information.

### 3116-3721
In 3116, Evangelyn's [[Nexerium]] starship was checked by [[Alestra]], however, the wear damage was too deep and couldn't be repaired, resulting on the ship being transported to the [[Technical University of Arc]], where it would be cleaned up and displayed to the passing students of the university.

[[Alestra]] had plans to build a new starship dedicated to exploration, but the development of deep space technologies were improving too rapidly to the point a starship would be obsolete by a much superior option each year. Evangelyn then decided to go back to her previous engineer career and in 3118, she was assigned at [[Poles#North Pole|North Pole]] where she would learn the true nature of [[Nova]].

In 3188, Evangelyn was assigned a new mission to escort [[Teryl]] to Sector 0A, near [[Earth]], using a [[Nessel]] warship, and kept guard of the area while a fleet of [[RingBuilder]]s were building a large library and archive ship, which would then be [[Teryl]]'s home. After the construction finished, Evangelyn visited [[Earth]] and tested the communication link with the library and its proxy link to [[Nova]], before going back to [[Nova]].
...
During the two decades, Evangelyn started getting new memories starting with the name "Skyra" appearing over and over. The family realised after a lot of testing that the nickname was only given to Evangelyn and that the sword followed only Evangelyn.

In 3739, it was determined that the [[Sxry]]'s power source was named [[Sxry#Lynn Gate|Lynn Gate]] and that it yielded a constant energy supply of 6 EWh, or 6 trillion MWh, however, all attempts to identify the sword's composition failed, as the findings seemingly always contradicted what was known. Following the investigation, the family tried to use the [[Sxry]] as a power source, however, this also failed, as the sword only let Evangelyn use its energy supply.

In 3744, Evangelyn started using the nickname Skyra after receiving memories of her past life with the same name.

### 3745-3746
In 3745, a librarian near [[Redlan]]'s home planet at the edge of [[ArchId]]'s librarian network detected a large invasion force of [[Kal-71]] and [[Gessherd]] ships, this force arrived at [[Nova]] on 3746, triggering the [[Third Novan War]]. During the invasion, the [[Sxry]] travelled to the [[Poles#South Pole|South Pole]] and later to [[Nova]]'s core, then appeared right besides Evangelyn, who was at the [[Poles#North Pole|North Pole]] trying to defend against the [[Gessherd]] forces, until the [[Incinerator Tower]]s enabled for first time and shot a continuous stream vertically at the sky, causing [[Nova]] to restart the atmosphere, killing all the [[Gessherd]] forces in the process.

### 3747-3898
In 3747, [[Alestra]] completed a new starship with great combat capabilities and with the integration of the [[Sxry]] as an additional energy source in mind. This opened the door for more powerful weapons that were limited to [[Nova]] and backed up by large energy grids. One such introduction was the [[Spectra]] cannons as well as a [[Sniper]] cannon in the centre for long-range attacks.

To accommodate for this advanced weapon arsenal, a new [[NEμAI]] class was created, [[Electrawing]], and thus Skyra's new warship codename would be `WPEW-EEA-0`. The upgrade finished in 3752, but unlike her previous class, where she was the only one of her class, there would be 250 [[Electrawing]]-class built after her, who was the prototype.

In 3755, a small fleet of 120 [[Electrawing]] warships, 45 [[Noirwing]] support ships, 5 [[Tesserium]] scout warships, and a [[Thaesse]] support ship with [[Iriss]] marched further into [[ArchId]] non-mapped space, with a fleet building new libraries to connect more sectors of the Milky Way into the scanning grid.

The fleet encountered resistance from many enemy [[Kal-71]] outposts found during the expedition, however, despite being outnumbered in almost every case, the fleet survived the expedition until 3898 with minimal loses. At this point, [[ArchId]] had a library in almost every sector of the Milky Way: most of galaxy is now actively mapped and scanned, with all the data going to the [[ArchId Ring]] and finally creating an accurate and very detailed map tracking every single event in the scanned sectors.

However, despite not finding any more [[Kal-71]] outposts, or any [[Gessherd]] colonies within the scanned sectors, librarians still picked up unidentified activity from time to time near the galaxy's borders. [[ArchId]] officials sent fleets to colonise planets in neighbouring sectors so they could create permanent settlements for military androids to live in with comfortable conditions far away from their home planet [[Nova]].
...
### 4413-33150
In 4413, Skyra transitioned to [[Flamewing]] alongside 49 more androids. This upgrade from [[Electrawing]] was significant, as it included the [[Novan Heart]], an energy supply made of [[Pure Energy#LEP|LEP]], and an upgraded processing array going from 2 neural and 4 arithmetic processors to 6 neural, 8 arithmetic, and a data processing processor, which was miniaturized using hyperspace compression technology. The last upgrade was that her capacitive artificial skin was replaced with a nanite mesh that projected hard light, which was not possible to achieve before due to energy consumption.

Skyra also received a new starship, courtesy of [[Alestra]], the agile space superiority warship codenamed `WAFW-EEA-A1`, which could complete the travel from [[Nova]] to [[Earth]] in under one hour, compared to the 3 weeks of the previous design. The warship also featured 2 large backup [[Pure Energy#LEP|LEP]] batteries which would be used to offload energy consumption from Skyra's heart and push speeds never seen before.
...
In 10020, with an improved warship featuring hyperspace compressed data banks and more efficient [[Pure Energy#LEP|LEP]] banks, Skyra started another expedition, this time to [Segue 1](https://en.wikipedia.org/wiki/Segue_1), then the nearby [Ursa Major II Dwarf](https://en.wikipedia.org/wiki/Ursa_Major_II_Dwarf), finishing at the [Sagittarius Dwarf Spheroidal Galaxy](https://en.wikipedia.org/wiki/Sagittarius_Dwarf_Spheroidal_Galaxy) before going back to [[Nova]] for refuelling and data uploading in 33150.
