...
## Locations
Because the ECC requires a [[Core Conduit]], only two ECCs were built:
- [[Arc City]] (north conduit).
- [[Stella|Stella]] (south conduit).

[[Arc City]] was chosen because of its proximity to the [[Poles#North Pole|North Pole]], as well as its high defense capabilities thanks to its 2 [[Hexa 4|Hexa 4]] and its undergoing plans to build a [[Hexa 5|Hexa 5]].
...
## Defenses
Due to the importance and rarity of the ECCs, they are also the most protected places in Nova, more than [[Hexa 5|Hexa 5]], which is the most protected conventional defense building. To ensure this, both ECCs come with the following defenses:
...
## Controversies
1. [[ArchId|ArchId]] is a peaceful civilization, and it's why many other civilizations accept partnerships and trade relationships with them. However, ECCs' defenses and the high military presence in their vicinities come in conflict with this popular view, which is one of the reasons why Nova's High Command has tried to conceal all the weapons and make the military less visible, using invisible Relative devices to prevent accidental unauthorized access.
...
4. ECCs are core facilities that create the portable energy device, [[Shiny]], which makes them an attractive target for any attacker, specially [[Kal-71]], making the surrounding area risky in case of an attack.